...
<head>
    ...
    <title>Warm Souvenir</title>

    <!-- favicons -->
    <link href="assets/img/111.png" rel="icon" />
        ...
        <div class="container">
            ...
            <div class="shopping-cart">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="table-bottom">
                            ...
                            <td style="border: 0;"><?php echo $grand_total; ?>$</td>
                ...
                <div class="cart-btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">
                    <a href="delivery.php" class="btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">PAY NOW</a>
                </div>
